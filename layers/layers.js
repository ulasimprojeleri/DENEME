...
lyr_WebmapGuzergahguzergah_1.set('fieldImages', {'fid': '', 'ILCE': '', 'PROJEADI': '', 'YIL': '', 'ProjeNo': '', 'TIP': '', });
lyr_WebmapNoktasalnoktasal_2.set('fieldImages', {'fid': '', 'ILCE': '', 'PROJEADI': '', 'YIL': '', 'PROJENO': '', 'TIP': '', });
lyr_WebmapGuzergahguzergah_1.set('fieldLabels', {'fid': 'hidden field', 'ILCE': 'inline label - always visible', 'PROJEADI': 'header label - always visible', 'YIL': 'inline label - always visible', 'ProjeNo': 'inline label - always visible', 'TIP': 'inline label - always visible', });
